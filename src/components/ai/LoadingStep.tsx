  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6 space-y-8">
      <div className="space-y-2 text-center">
        <h2 className="text-2xl font-bold tracking-tight">Generuję fiszki...</h2>
        <p className="text-muted-foreground">AI analizuje Twoje notatki i tworzy fiszki. To może potrwać chwilę.</p>
      </div>
      ...
      <div className="bg-muted/50 rounded-lg p-4 space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Generowanie może zająć do 2 minut w zależności od długości tekstu. W międzyczasie możesz przygotować kolejne
          notatki.
        </p>
      </div>
    </div>
